...
func NewDefaultSyncService(client *tube_service.YoutubeSyncClient, mongoRepository *sync_repository.MongoVideoRepository) *DefaultMongoSyncService {
	return &DefaultMongoSyncService{Client: client, Repository: mongoRepository}
}
