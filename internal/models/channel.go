...
type Channel struct {
	...
	Count                  float32    `mapstructure:"count" json:"count,omitempty" gorm:"column:count;primary_key" bson:"count,omitempty" dynamodbav:"count,omitempty" firestore:"count,omitempty"`
	...
	ItemCount              float32    `mapstructure:"itemCount" json:"itemCount,omitempty" gorm:"column:itemCount;primary_key" bson:"itemCount,omitempty" dynamodbav:"itemCount,omitempty" firestore:"itemCount,omitempty"`
	...
	PlaylistCount          float32    `mapstructure:"playlistCount" json:"playlistCount,omitempty" gorm:"column:playlistCount;primary_key" bson:"playlistCount,omitempty" dynamodbav:"playlistCount,omitempty" firestore:"playlistCount,omitempty"`
	PlaylistItemCount      float32    `mapstructure:"playlistItemCount" json:"playlistItemCount,omitempty" gorm:"column:playlistItemCount;primary_key" bson:"playlistItemCount,omitempty" dynamodbav:"playlistItemCount,omitempty" firestore:"playlistItemCount,omitempty"`
	PlaylistVideoCount     float32    `mapstructure:"playlistVideoCount" json:"playlistVideoCount,omitempty" gorm:"column:playlistVideoCount;primary_key" bson:"playlistVideoCount,omitempty" dynamodbav:"playlistVideoCount,omitempty" firestore:"playlistVideoCount,omitempty"`
	PlaylistVideoItemCount float32    `mapstructure:"playlistVideoItemCount" json:"playlistVideoItemCount,omitempty" gorm:"column:playlistVideoItemCount;primary_key" bson:"playlistVideoItemCount,omitempty" dynamodbav:"playlistVideoItemCount,omitempty" firestore:"playlistVideoItemCount,omitempty"`
	...
	LastUpload             *time.Time `mapstructure:"lastUpload" json:"lastUpload,omitempty" gorm:"column:lastUpload;primary_key" bson:"lastUpload,omitempty" dynamodbav:"lastUpload,omitempty" firestore:"lastUpload,omitempty"`
