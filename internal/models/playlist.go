...
type ListResultPlaylist struct {
	List          []Playlist `mapstructure:"list" json:"list,omitempty" gorm:"column:list;primary_key" bson:"list,omitempty" dynamodbav:"list,omitempty" firestore:"list,omitempty"`
