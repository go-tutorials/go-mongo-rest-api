...
type ChannelSync struct {
	...
	Level    int16      `mapstructure:"level" json:"level,omitempty" gorm:"column:level;primary_key" bson:"level,omitempty" dynamodbav:"level,omitempty" firestore:"level,omitempty"`
}
