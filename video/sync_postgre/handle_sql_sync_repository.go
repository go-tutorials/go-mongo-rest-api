...
func (s *SQLVideoRepository) GetChannelSync(ctx context.Context, channelId string) (*models.ChannelSync, error) {
	rows, err := s.DB.Query(`select * from channelSync where id = $1 limit 1`, channelId)
	if err != nil {
		return nil, err
	}
	var channeSync models.ChannelSync
	for rows.Next() {
...
func (s *SQLVideoRepository) SaveChannel(ctx context.Context, channel models.Channel) (int64, error) {
...
func (s *SQLVideoRepository) SaveVideos(ctx context.Context, videos []models.Video) (int, error) {
...
func (s *SQLVideoRepository) SavePlaylists(ctx context.Context, playlists []models.Playlist) (int, error) {
...
func (s *SQLVideoRepository) SavePlaylistVideos(ctx context.Context, playlistId string, videos []string) (int, error) {
	...
	playlistVideos := models.PlaylistVideoIdVideos{
		Id:     playlistId,
		Videos: videos,
	}
...
func (s *SQLVideoRepository) SaveChannelSync(ctx context.Context, channel models.ChannelSync) (int, error) {
...
func (s *SQLVideoRepository) SavePlaylist(ctx context.Context, playlist models.Playlist) (int, error) {
