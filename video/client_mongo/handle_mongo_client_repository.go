...
func (m *MongoVideoService) GetChannel(ctx context.Context, channelId string, fields []string) (*models.Channel, error) {
...
func (m *MongoVideoService) GetChannels(ctx context.Context, ids []string, fields []string) (*[]models.Channel, error) {
...
func (m *MongoVideoService) GetPlaylist(ctx context.Context, id string, fields []string) (*models.Playlist, error) {
	query := bson.M{"_id": id}
...
func (m *MongoVideoService) GetPlaylists(ctx context.Context, ids []string, fields []string) (*[]models.Playlist, error) {
	query := bson.M{"_id": bson.M{"$in": ids}}
	optionsFind := options.Find()
	if len(fields) > 0 {
		optionsFind.SetProjection(sel(fields...))
...
func (m *MongoVideoService) GetVideo(ctx context.Context, id string, fields []string) (*models.Video, error) {
	query := bson.M{"_id": id}
	optionsFindOne := options.FindOne()
	if len(fields) > 0 {
		optionsFindOne.SetProjection(sel(fields...))
...
func (m *MongoVideoService) GetVideos(ctx context.Context, ids []string, fields []string) (*[]models.Video, error) {
	query := bson.M{"_id": bson.M{"$in": ids}}
	optionsFind := options.Find()
	if len(fields) > 0 {
		optionsFind.SetProjection(sel(fields...))
...
func (m *MongoVideoService) GetChannelPlaylists(ctx context.Context, channelId string, max int, nextPageToken string, fields []string) (*models.ListResultPlaylist, error) {
	limit := getLimit(max)
	...
	var result models.ListResultPlaylist
	for res.Next(ctx) {
		var playlist models.Playlist
...
func (m *MongoVideoService) GetChannelVideos(ctx context.Context, channelId string, max int, nextPageToken string, fields []string) (*models.ListResultVideos, error) {
	...
	var result models.ListResultVideos
	for res.Next(ctx) {
		var video models.Video
		if er1 := res.Decode(&video); er1 != nil {
			return nil, err
...
func (m *MongoVideoService) GetPlaylistVideos(ctx context.Context, playlistId string, max int, nextPageToken string, fields []string) (*models.ListResultVideos, error) {
	limit := getLimit(max)
	skip, er0 := getSkip(nextPageToken)
	if er0 != nil {
		return nil, er0
	...
	var playlistVideo models.PlaylistVideoIdVideos
...
func (m *MongoVideoService) GetCagetories(ctx context.Context, regionCode string) (*models.Categories, error) {
	query := bson.M{"_id": regionCode}
	res := m.CategoryCollection.FindOne(ctx, query)
	var category models.Categories
	if res.Err() != nil {
		if strings.Contains(res.Err().Error(), "client_mongo: no documents in result") {
...
func (m *MongoVideoService) SearchChannel(ctx context.Context, channelSM models.ChannelSM, max int, nextPageToken string, fields []string) (*models.ListResultChannel, error) {
	limit := getLimit(max)
	skip, er0 := getSkip(nextPageToken)
	if er0 != nil {
		return nil, er0
	...
	result := models.ListResultChannel{}
	for res.Next(ctx) {
		var channel models.Channel
...
func (m *MongoVideoService) SearchPlaylists(ctx context.Context, playlistSM models.PlaylistSM, max int, nextPageToken string, fields []string) (*models.ListResultPlaylist, error) {
	limit := getLimit(max)
	skip, er0 := getSkip(nextPageToken)
	if er0 != nil {
		return nil, er0
	...
	result := models.ListResultPlaylist{}
	for res.Next(ctx) {
		var playlist models.Playlist
...
func (m *MongoVideoService) SearchVideos(ctx context.Context, itemSM models.ItemSM, max int, nextPageToken string, fields []string) (*models.ListResultVideos, error) {
	limit := getLimit(max)
	skip, er0 := getSkip(nextPageToken)
	if er0 != nil {
		return nil, er0
	...
	result := models.ListResultVideos{}
	for res.Next(ctx) {
		var video models.Video
		if er1 := res.Decode(&video); er1 != nil {
			return nil, er1
...
func (m *MongoVideoService) Search(ctx context.Context, itemSM models.ItemSM, max int, nextPageToken string, fields []string) (*models.ListResultVideos, error) {
	limit := getLimit(max)
	skip, er0 := getSkip(nextPageToken)
	if er0 != nil {
		return nil, er0
...
func (m *MongoVideoService) GetRelatedVideos(ctx context.Context, videoId string, max int, nextPageToken string, fields []string) (*models.ListResultVideos, error) {
	limit := getLimit(max)
	skip, er0 := getSkip(nextPageToken)
	if er0 != nil {
		return nil, er0
...
func (m *MongoVideoService) GetPopularVideos(ctx context.Context, regionCode string, categoryId string, max int, nextPageToken string, fields []string) (*models.ListResultVideos, error) {
	limit := getLimit(max)
	skip, er0 := getSkip(nextPageToken)
	if er0 != nil {
		return nil, er0
...
func buildQueryChannelSearch(channelSM models.ChannelSM) bson.D {
	query := bson.D{}
	if channelSM.Q != "" {
...
func buildQueryPlaylistSearch(playlistSM models.PlaylistSM) bson.D {
	query := bson.D{}
	if playlistSM.Q != "" {
...
func buildQueryVideoSearch(itemSM models.ItemSM) bson.D {
	query := bson.D{}
	if itemSM.Duration != "" {
